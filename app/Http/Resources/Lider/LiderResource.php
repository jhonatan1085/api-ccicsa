...
namespace App\Http\Resources\Lider;

use App\Http\Resources\Zona\ZonaUserResource;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

class LiderResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
           ...
           // "avatar" => env("APP_URL") . "storage/" . $this->resource->avatar,
            "zonas" => ZonaUserResource::collection($this->zona_user),
